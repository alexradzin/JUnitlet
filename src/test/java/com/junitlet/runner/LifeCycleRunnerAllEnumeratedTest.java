...
@RunnerLifeCycleHandler(
		...
		phase = {RunnerLifeCycle.BEFORE_CONSTRUCTOR, RunnerLifeCycle.AFTER_CONSTRUCTOR, RunnerLifeCycle.BEFORE_RUN, RunnerLifeCycle.AFTER_RUN})
@RunWith(LifeCycleRunner.class)
public class LifeCycleRunnerAllEnumeratedTest {
